...
if __name__ == "__main__": 
    ...
    ax[0][1].imshow(sobel(img_gray), aspect="auto", cmap='gray')
    ax[0][2].imshow(prewitt(img_gray), aspect="auto", cmap='gray')
    ax[1][0].imshow(roberts(img_gray), aspect="auto", cmap='gray')
    ax[1][1].imshow(scharr(img_gray), aspect="auto", cmap='gray')
    ax[1][2].imshow(canny(img_gray), aspect="auto", cmap='gray')
    ax[2][0].imshow(blob(img_gray), aspect="auto", cmap='gray')
    ax[2][1].imshow(LoG(img_gray), aspect="auto", cmap='gray')
    ax[2][2].imshow(DoG(img_gray), aspect="auto", cmap='gray')
